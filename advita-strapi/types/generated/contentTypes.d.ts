...
export interface ApiAdventCellAdventCell extends Struct.CollectionTypeSchema {
  collectionName: 'advent_cells';
  info: {
    displayName: 'Advent cell';
    pluralName: 'advent-cells';
    singularName: 'advent-cell';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    cell_type: Schema.Attribute.Enumeration<['text', 'quiz', 'sticker']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::advent-cell.advent-cell'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    quiz_correct_answer: Schema.Attribute.Integer;
    quiz_options: Schema.Attribute.JSON;
    sticker_file_id: Schema.Attribute.String;
...
export interface ApiStatsEventStatsEvent extends Struct.CollectionTypeSchema {
  collectionName: 'stats_events';
  info: {
    displayName: 'Stats event';
    pluralName: 'stats-events';
    singularName: 'stats-event';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    >;
    event_value: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::stats-event.stats-event'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTelegramUserTelegramUser
  ...
  attributes: {
    consent_given: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    last_notification_date: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    new_year_congrat_sent: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUserProgressUserProgress
  ...
  attributes: {
    cell: Schema.Attribute.Relation<
      'manyToOne',
      'api::advent-cell.advent-cell'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    publishedAt: Schema.Attribute.DateTime;
    reward_received: Schema.Attribute.Boolean &
...
export interface ApiUserQuestionUserQuestion
  ...
  attributes: {
    ...
    state: Schema.Attribute.Enumeration<['new', 'in_progress', 'answered']> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::advent-cell.advent-cell': ApiAdventCellAdventCell;
      'api::faq.faq': ApiFaqFaq;
      'api::stats-event.stats-event': ApiStatsEventStatsEvent;
